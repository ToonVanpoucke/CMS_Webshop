...
/**
 * Pantheon Database & Trusted Host Instellingen.
 */
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
    ...
    // 2. Trusted Host Patterns (Nodig voor Drupal 11)
    $settings['trusted_host_patterns'] = [
        '^.*\.pantheonsite\.io$',
    ];

    // 3. Hash Salt (Voor beveiliging)
    $settings['hash_salt'] = $_ENV['DRUPAL_HASH_SALT'] ?? 'vervang-dit-door-iets-willekeurigs';
}
/**
